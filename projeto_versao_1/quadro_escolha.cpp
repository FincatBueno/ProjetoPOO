...
void quadro_escolha::buttonDisplay(){
    ...
    escolha1->setGeometry(570, 670, 350, 55);

    QPushButton *escolha2 = new QPushButton("Fazer isso", this);
    escolha2->setGeometry(10, 670, 350, 55);
    ...
    escolha1->setStyleSheet("background-color: black;"
                              "border-style: outset;"
                              "color: white;"
                              "font-size: 28px");

    escolha2->setStyleSheet("background-color: black;"
                              "border-style: outset;"
                              "color: white;"
                              "font-size: 28px");
